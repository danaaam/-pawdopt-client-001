...
import alleonard from "../assets/alleonard.png"
        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
          ...
          >
            ...
            <li className="mx-auto flex max-w-xs flex-col items-center gap-4 px-8 py-6 text-center">
              ...
              Animal Caretaker, Veterinarians and Veterinary Technicians
              </p>
            </li>
            <li className="mx-auto flex max-w-xs flex-col items-center gap-4 px-8 py-6 text-center">
              <img
            ...
            <li className="mx-auto flex max-w-xs flex-col items-center gap-4 px-8 py-6 text-center">
              ...
              <p className="text-sm text-[#636262]">Client Services Representative</p>
            </li>
          </ul>
        </div>
      </section>
